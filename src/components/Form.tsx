...
export default function Form() {
    ...
    const isValidActivity = () => {
        ...
        console.log(name.trim() !== "" && category !== 0 && calories > 0);
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        console.log(activity);// This line add the activity object to the console
    };
    ...
    return (
        ...
        >
            ...
            <input
                type="submit"
                className="bg-blue-500 hover:bg-gray-600 text-white font-bold py-2 rounded-lg uppercase w-full cursor-pointer transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                value={addActivity()}
